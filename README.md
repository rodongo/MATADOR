...
├── main_MATADOR.m                    # Entry point: average + personalized
└── gradedMATADOR_Sensitivity_Analysis.m  # Entry point: graded analysis
```
...
| Metabolite | AssociatedConsuming |
|---|---|
