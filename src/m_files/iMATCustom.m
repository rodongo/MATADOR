...
function tissueModel = iMATCustom(model, expressionRxns, threshold_lb, threshold_ub, tol, core, logfile, runtime, epsilon)
...
if nargin < 5 || isempty(core)
    ...
    solution = solveCobraMILPCustom(MILPproblem, 'timeLimit', runtime, 'logFile', logfile, 'printLevel', 3);
